...
npx skills add vmware-skills/VMware-AIops#v1.9.4

# Via ClawHub (fetches from ClawHub registry snapshot of GitHub)
clawhub install @zw008/vmware-aiops --version 1.9.4
```
...
```bash
git clone --branch v1.9.4 https://github.com/vmware-skills/VMware-AIops.git
cd VMware-AIops
